...
! function(t, e) {
 ...
 return function(t) {
  ...
  n.prototype.setOptions = function(t) {
   t && void 0 !== t.queue && (!1 === t.queue ? this._queue && (this._queue.destroy(), delete this._queue) : (this._queue || (this._queue = c.extend(this, {
    ...
    return (0, a.default)(t, [{
     ...
     value: function(t) {
      ...
      return this.labelModule.visible() && l.pointInRect(this.labelModule.getSize(), t) && e.push({
       nodeId: this.id,
       labelId: 0
      }), l.pointInRect(this.shape.boundingBox, t) && e.push({
       nodeId: this.id
      }), e
     }
    }, {
    ...
    return (0, d.default)(t, null, [{
     ...
     value: function(t, e) {
      var i = ["node", "edge", "label"],
       o = !0,
       n = l.topMost(e, "chosen");
      if ("boolean" == typeof n) o = n;
      else if ("object" === (void 0 === n ? "undefined" : (0, s.default)(n))) {
  ...
  o.prototype = new s, o.prototype._create = function() {
   ...
   this.options.showCurrentTime = !0, this.redraw(), this.body = null
  }, o.prototype.setOptions = function(t) {
  ...
  o.prototype._create = function() {
   ...
   if (f > 0)
    for (var v = 0; v < f; v++) r.forEach(p, function(t) {
     t[v]()
    });
        ...
        if ("function" == typeof n && !1 === (o = n(r, e)) && !(a instanceof Array) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, o = this._handleObject(a, h, !0), this.allowCreation = !1 === i), !1 !== o) {
         ...
         if (a instanceof Array) this._handleArray(a, d, h);
          ...
          if (-1 !== e.indexOf("physics") && this.moduleOptions.physics.solver !== r && (l = !1), !0 === l)
           if (void 0 !== a.enabled) {
            var u = c.copyAndExtendArray(h, "enabled"),
             p = this._getValue(u);
            if (!0 === p) {
    ...
    return (0, p.default)(t, [{
     ...
     value: function(t) {
      ...
      if (this.labelModule.visible()) {
       ...
       v.pointInRect(this.labelModule.getSize(), t, i) && e.push({
        edgeId: this.id,
        labelId: 0
       })
      }
     ...
     value: function(t, e) {
      ...
      if (void 0 !== e.color && null !== e.color) {
       var l = e.color,
        u = t.color;
       if (n) f.deepExtend(u, o.color, !1, i);
       else
        for (var c in u) u.hasOwnProperty(c) && delete u[c];
       if (f.isString(u)) u.color = u, u.highlight = u, u.hover = u, u.inherit = !1, void 0 === l.opacity && (u.opacity = 1);
       else {
        var p = !1;
  ...
  t.exports = function(t, e, i, m, v, g, y) {
   ...
   if (T && (w = u(T.call(new t))) !== Object.prototype && w.next && (l(w, k, !0), o || a(w, c) || r(w, c, f)), S && C && "values" !== C.name && (D = !0, O = function() {
     return C.call(this)
    }), o && !y || !p && !D && M[c] || r(M, c, O), h[e] = O, h[k] = f, v)
    if (b = {
      values: S ? O : x("values"),
      keys: g ? O : x("keys"),
      entries: E
  ...
  n.prototype = new f, n.types = {
   ...
   if (this.touchParams.itemProps) {
    ...
    this.touchParams.itemProps.forEach(function(d) {
     var u, c, p, f, m, v = i.body.util.toTime(t.center.x - e),
     ...
     if (null == d.item.editable || d.item.editable.updateTime || d.item.editable.updateGroup || i.options.editable.overrideItems) {
      if ((this.options.editable.overrideItems || null == r.editable) && this.options.editable.updateTime || !this.options.editable.overrideItems && null != r.editable && r.editable.updateTime)
       ...
       if (c = l.convert(d.data.start, "Date").valueOf(), f = new Date(c + u), void 0 != y.end) {
   ...
   if (this.options.groupEditable.order && this.groupTouchParams.group) {
    ...
    if (i && i != this.groupTouchParams.group) {
     ...
     if (!l.equalArray(d, this.groupTouchParams.originalOrder))
      for (var u = this.groupTouchParams.originalOrder, p = this.groupTouchParams.group.groupId, f = Math.min(u.length, d.length), m = 0, v = 0, g = 0; m < f;) {
       for (; m + v < f && m + g < f && d[m + v] == u[m + g];) m++;
       if (m + v >= f) break;
       if (d[m + v] == p) v = 1;
       else if (u[m + g] == p) g = 1;
       else {
        var y = d.indexOf(u[m + g]),
         b = e.get(d[m + v]),
         _ = e.get(u[m + g]);
  ...
  var n = i(30),
   ...
   v = function() {
    ...
    return (0, u.default)(t, [{
     key: "setOptions",
     value: function(t) {
      if (this.elementOptions = t, this.initFontOptions(t.font), p.isValidLabel(t.label) ? this.labelDirty = !0 : t.label = "", void 0 !== t.font && null !== t.font)
       if ("string" == typeof t.font) this.baseSize = this.fontOptions.size;
       else if ("object" === (0, a.default)(t.font)) {
       var e = t.font.size;
     ...
     value: function(t) {
      ...
      else if ("object" === (void 0 === i ? "undefined" : (0, a.default)(i))) {
      ...
      else if ("object" === (void 0 === s ? "undefined" : (0, a.default)(s))) {
      ...
      for (var h = 0; h < this.lineCount; h++) {
       ...
       if (d && d.blocks) {
        ...
        for (var u = 0; u < d.blocks.length; u++) {
         var c = d.blocks[u];
         t.font = c.font;
         var p = this._getColor(c.color, n, c.strokeColor),
          f = (0, s.default)(p, 2),
          m = f[0],
          v = f[1];
    ...
    return (0, d.default)(t, [{
     ...
     value: function(t) {
      ...
      if (this.from != this.to) e = this._findBorderPosition(this.from, t), i = this._findBorderPosition(this.to, t);
       ...
       var o = this._getCircleData(t).slice(0, 2),
        n = (0, s.default)(o, 2),
        r = n[0],
        a = n[1];
  ...
  var o = i(18),
   ...
   U = function(t, e, i) {
    return t === B && U(F, e, i), y(t), e = _(e, !0), y(i), n(L, e) ? (i.enumerable ? (n(t, N) && t[N][e] && (t[N][e] = !1), i = x(i, {
     enumerable: w(0, !1)
    })) : (n(t, N) || O(t, N, w(1, {})), t[N][e] = !0), Y(t, e, i)) : O(t, e, i)
   },
   q = function(t, e) {
    y(t);
  ...
  (function(t) {
   ! function(e, i) {
    ...
    function f(t) {
     if (null == t._isValid) {
      var e = p(t),
       i = Oo.call(e.parsedDateParts, function(t) {
        return null != t
       }),
    ...
    function v(t, e) {
     var i, o, n;
     if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), s(e._i) || (t._i = e._i), s(e._f) || (t._f = e._f), s(e._l) || (t._l = e._l), s(e._strict) || (t._strict = e._strict), s(e._tzm) || (t._tzm = e._tzm), s(e._isUTC) || (t._isUTC = e._isUTC), s(e._offset) || (t._offset = e._offset), s(e._pf) || (t._pf = p(e)), s(e._locale) || (t._locale = e._locale), Eo.length > 0)
      for (i = 0; i < Eo.length; i++) o = Eo[i], n = e[o], s(n) || (t[o] = n);
     return t
    }
    ...
    function te(t, e) {
     if (null !== e) {
      var i = An;
      if (e.abbr = t, null != zn[t]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = zn[t]._config;
    ...
    function he(t) {
     var e, i, o, n, s, r, a, h;
     if (e = t._w, null != e.GG || null != e.W || null != e.E) s = 1, r = 4, i = se(e.GG, t._a[dn], kt(De(), 1, 4).year), o = se(e.W, 1), ((n = se(e.E, 1)) < 1 || n > 7) && (h = !0);
     else {
    ...
    function de(t) {
     var e, i, o, n, s, r, a = t._i,
      h = Fn.exec(a) || Bn.exec(a);
     if (h) {
      for (p(t).iso = !0, e = 0, i = Hn.length; e < i; e++)
       if (Hn[e][1].exec(h[1])) {
        n = Hn[e][0], o = !1 !== Hn[e][2];
        break
       } if (null == n) return void(t._isValid = !1);
      if (h[3]) {
       for (e = 0, i = Wn.length; e < i; e++)
        if (Wn[e][1].exec(h[3])) {
         s = (h[2] || " ") + Wn[e][0];
         break
    ...
    function xe(t) {
     var e = t._i,
      o = t._f;
     return t._locale = t._locale || ie(t._l), null === e || void 0 === o && "" === e ? m({
      nullInput: !0
     }) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), y(e) ? new g(ne(e)) : (a(e) ? t._d = e : i(o) ? be(t) : o ? ge(t) : ke(t), f(t) || (t._d = null), t))
    }
    ...
    function Mo() {
     if (!this.isValid()) return this.localeData().invalidDate();
     var t, e, i, o = Cs(this._milliseconds) / 1e3,
      n = Cs(this._days),
      s = Cs(this._months);
  ...
  o.DEFAULTS = {
   ...
   if (this.style === o.STYLE.GRID || this.style === o.STYLE.SURFACE) {
    ...
    for (n = 0; n < r.length; n++) {
     s = r[n];
     var l = a.indexOf(s.point.x),
      u = h.indexOf(s.point.y);
     void 0 === d[l] && (d[l] = []), d[l][u] = s
    }
    for (e = 0; e < d.length; e++)
     for (i = 0; i < d[e].length; i++) d[e][i] && (d[e][i].pointRight = e < d.length - 1 ? d[e + 1][i] : void 0, d[e][i].pointTop = i < d[e].length - 1 ? d[e][i + 1] : void 0, d[e][i].pointCross = e < d.length - 1 && i < d[e].length - 1 ? d[e + 1][i + 1] : void 0)
   } else if (this._checkValueField(t), r = this.getDataPoints(t), this.style === o.STYLE.LINE)
    for (n = 0; n < r.length; n++) n > 0 && (r[n - 1].pointNext = r[n]);
   return r
   ...
   var p = [{
    ...
    corners: [u[3], u[0], c[0], c[3]],
    center: l.avg(c[0].point, c[3].point)
   }];
   e.surfaces = p;
  ...
  var o = i(17);
  o(o.S + o.F * !i(21), "Object", {
   defineProperty: i(20).f
  })
 }, function(t, e, i) {
  Object.defineProperty(e, "__esModule", {
   value: !0
  ...
  o.prototype.initializeData = function(t, e, i) {
   ...
   var n = this._collectRangeSettings(e, i),
   ...
   for (var i = [], o = 0; o < e.length; o++) {
    var n = e[o][t] || 0; - 1 === i.indexOf(n) && i.push(n)
   }
   ...
   var e, i, o, n, s = this.getDistinctValues(this.colX, t),
    r = this.getDistinctValues(this.colY, t),
    a = this.getDataPoints(t),
    h = [];
   for (o = 0; o < a.length; o++) {
    n = a[o];
    var d = s.indexOf(n.point.x),
     l = r.indexOf(n.point.y);
    void 0 === h[d] && (h[d] = []), h[d][l] = n
   }
   for (e = 0; e < h.length; e++)
    for (i = 0; i < h[e].length; i++) h[e][i] && (h[e][i].pointRight = e < h.length - 1 ? h[e + 1][i] : void 0, h[e][i].pointTop = i < h[e].length - 1 ? h[e][i + 1] : void 0, h[e][i].pointCross = e < h.length - 1 && i < h[e].length - 1 ? h[e + 1][i + 1] : void 0);
   return a
   ...
   var e = [];
   if (this.style === h.STYLE.GRID || this.style === h.STYLE.SURFACE) e = this.initDataAsMatrix(t);
   else if (this._checkValueField(t), e = this.getDataPoints(t), this.style === h.STYLE.LINE)
    for (var i = 0; i < e.length; i++) i > 0 && (e[i - 1].pointNext = e[i]);
   return e
  ...
  o.prototype = new c, o.prototype._createConfigurator = function() {
   ...
   if (this.itemsData && void 0 != t) {
    ...
    if (o.forEach(function(t) {
     ...
     v || (l = {
      ...
      scrollOffset: -1,
      itemTop: -1
     }), this.range.setRange(f - m / 2, f + m / 2, {
      animation: v
     }, p, u)
    }
   }
   ...
   if (null != e && null != i) {
    ...
    if (u > 0)
     for (var c = 0; c < u; c++) h.forEach(l, function(t) {
      t[c]()
     });
    ...
    return (0, a.default)(t, [{
     ...
     value: function(t) {
      var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
       i = this.groups[t];
      if (void 0 === i && e)
       if (!1 === this.options.useDefaultGroups && this.groupsArray.length > 0) {
  ...
  var n = i(0),
   ...
   c = function() {
    ...
    return (0, a.default)(t, [{
     ...
     value: function(t) {
      if (void 0 !== t) {
       if (u.parseOptions(this.options, t), void 0 !== t.shape)
        for (var e in this.body.nodes) this.body.nodes.hasOwnProperty(e) && this.body.nodes[e].updateShape();
       if (void 0 !== t.font)
        for (var i in this.body.nodes) this.body.nodes.hasOwnProperty(i) && (this.body.nodes[i].updateLabelModule(), this.body.nodes[i].needsRefresh());
       if (void 0 !== t.size)
     ...
     value: function(t) {
      ...
      if (t instanceof d || t instanceof l) this.body.data.nodes = t;
     ...
     value: function(t, e) {
      ...
      if (void 0 !== this.body.nodes[t])
       for (var o = this.body.nodes[t], n = {}, s = 0; s < o.edges.length; s++) {
        var r = o.edges[s];
    ...
    return (0, a.default)(t, [{
     ...
     value: function() {
      ...
      this.body.emitter.on("_forceDisableDynamicCurves", function(e) {
       ...
       var o = !1;
       for (var n in t.body.edges)
        if (t.body.edges.hasOwnProperty(n)) {
     ...
     value: function(t) {
      ...
      if (t instanceof d || t instanceof l) this.body.data.edges = t;
  ...
  var n = i(30),
   ...
   y = function(t) {
    ...
    return (0, m.default)(e, t), (0, u.default)(e, [{
     ...
     value: function(t) {
      var e = !1;
      this.options.physics !== t.physics && (e = !0), this.options = t, this.id = this.options.id, this.from = this.body.nodes[this.options.from], this.to = this.body.nodes[this.options.to], this.setupSupportNode(), this.connect(), !0 === e && (this.via.setOptions({
   ...
   _ = function() {
    ...
    return (0, d.default)(t, [{
     ...
     value: function() {
      var t = this.body.nodes;
      for (var e in t)
       if (t.hasOwnProperty(e) && t[e].x && t[e].y) {
    ...
    return (0, u.default)(t, [{
       ...
       ! function(o) {
        ...
        if (void 0 === r[v]) {
         ...
         if (d === t) {
          ...
          if ((0, s.default)(l).length > 0 && (0, s.default)(m).length > 0 && !0 === b)
           if (c = function() {
             for (var t = 0; t < n.length; ++t)
              for (var e in l)
               if (void 0 !== n[t].nodes[e]) return n[t]
            }, void 0 !== (f = c())) {
     ...
     value: function(t, e, i, o) {
      ...
      for (var m = [], v = 0; v < c.length; v++) {
       ...
       null === b ? (b = this._createClusteredEdge(g.fromId, g.toId, y, o), m.push(b)) : b.clusteringEdgeReplacingIds.push(y.id), this.body.edges[y.id].edgeReplacedById = b.id, this._backupEdgeOptions(y), y.setOptions({
        physics: !1
       })
      }
     }
     ...
     value: function(t, e, i) {
      var o = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3],
       n = [];
      for (var r in t) t.hasOwnProperty(r) && void 0 !== this.clusteredNodes[r] && n.push(r);
      for (var a = 0; a < n.length; ++a) delete t[n[a]];
      if (0 != (0, s.default)(t).length && (1 != (0, s.default)(t).length || 1 == i.clusterNodeProperties.allowSingleNodeCluster)) {
       var h = c.deepExtend({}, i.clusterNodeProperties);
       if (void 0 !== i.processProperties) {
        var d = [];
        for (var l in t)
         if (t.hasOwnProperty(l)) {
          var u = p.cloneOptions(t[l]);
          d.push(u)
         } var m = [];
        for (var v in e)
         if (e.hasOwnProperty(v) && "clusterEdge:" !== v.substr(0, 12)) {
          var g = p.cloneOptions(e[v], "edge");
          m.push(g)
         } if (!(h = i.processProperties(h, d, m))) throw new Error("The processProperties function does not return properties!")
       }
       void 0 === h.id && (h.id = "cluster:" + c.randomUUID());
       var y = h.id;
       void 0 === h.label && (h.label = "cluster");
       var b = void 0;
       void 0 === h.x && (b = this._getClusterPosition(t), h.x = b.x), void 0 === h.y && (void 0 === b && (b = this._getClusterPosition(t)), h.y = b.y), h.id = y;
       var _ = this.body.functions.createNode(h, f);
       _.containedNodes = t, _.containedEdges = e, _.clusterEdgeProperties = i.clusterEdgeProperties, this.body.nodes[h.id] = _, this._clusterEdges(t, e, h, i.clusterEdgeProperties), h.id = void 0, !0 === o && this.body.emitter.emit("_dataChanged")
      }
     }
    }, {
     ...
     value: function(t, e) {
      ...
      for (var w = 0; w < b.length; w++) {
       for (var x = b[w], k = this._getConnectedId(x, t), S = this.clusteredNodes[k], D = 0; D < x.clusteringEdgeReplacingIds.length; D++) {
        var M = x.clusteringEdgeReplacingIds[D],
         C = this.body.edges[M];
        if (void 0 !== C)
         if (void 0 !== S) {
        ...
        if (void 0 !== r) {
         ...
         if (void 0 === a) o.push(s);
          ...
          for (var h = 0; h < a.length; ++h) {
           var d = a[h]; - 1 === e.indexOf(a) && -1 === i.indexOf(a) && e.push(d)
          }
         i.push(s)
        }
       }
     ...
     value: function(t, e, i, o) {
      ...
      for (var h in e)
       if (e.hasOwnProperty(h) && void 0 !== this.body.edges[h]) {
     ...
     value: function() {
      ...
      for (e in this.clusteredNodes)
       if (this.clusteredNodes.hasOwnProperty(e)) {
      ...
      c.forEach(this.clusteredEdges, function(e) {
       ...
       var n = !0,
        s = e.clusteringEdgeReplacingIds;
       if (void 0 !== s) {
        var r = 0;
      ...
      c.forEach(h, function(e) {
       var i = t.body.edges[e],
        o = t._isClusteredNode(i.fromId) || t._isClusteredNode(i.toId);
     ...
     value: function(t) {
      ...
      delete this.containedNodes[t], f.forEach(i.edges, function(t) {
       ...
       f.forEach(e.edges, function(i) {
        var o = i.clusteringEdgeReplacingIds.indexOf(t.id); - 1 !== o && (f.forEach(t.clusteringEdgeReplacingIds, function(t) {
   ...
   u = function() {
    ...
    return (0, a.default)(t, [{
     ...
     value: function() {
      ...
      if (this.frame = document.createElement("div"), this.frame.className = "vis-network", this.frame.style.position = "relative", this.frame.style.overflow = "hidden", this.frame.tabIndex = 900, this.frame.canvas = document.createElement("canvas"), this.frame.canvas.style.position = "relative", this.frame.appendChild(this.frame.canvas), this.frame.canvas.getContext) this._setPixelRatio(), this.setTransform();
      else {
       var t = document.createElement("DIV");
     ...
     value: function(t, e) {
      var i = function(t, e) {
       for (var i = [], o = 0; o < t.length; o++) {
        var n = t[o]; - 1 === e.indexOf(n) && i.push(n)
       }
       return i
      };
      return {
    ...
    return (0, p.default)(t, [{
     ...
     value: function(t) {
      ...
      return function t(o) {
       ...
       if (e.childrenReference[o]) {
        ...
        if (s.length > 0)
         for (var r = 0; r < s.length; r++) n = Math.max(n, t(s[r]))
       }
       return i[o] = n, n
      }(t)
     }
     ...
     value: function(t, e) {
      ...
      for (var r in this.trees)
       if (this.trees.hasOwnProperty(r) && this.trees[r] === e) {
        var a = t[r];
    ...
    return (0, p.default)(t, [{
     ...
     value: function(t) {
      if (!0 === this.options.hierarchical.enabled) {
       ...
       }, e.enabled = void 0 === e.enabled || e.enabled, e.solver = e.solver || "barnesHut") : "object" === (0, a.default)(t.physics) ? (e.enabled = void 0 === t.physics.enabled || t.physics.enabled, e.solver = t.physics.solver || "barnesHut", t.physics.solver = "hierarchicalRepulsion") : !1 !== t.physics && (e.solver = "barnesHut", t.physics = {
        solver: "hierarchicalRepulsion"
       });
     ...
     value: function() {
      ...
      !0 === this.options.hierarchical.blockShifting && (function(i) {
        ...
        for (var n = 0; n < i; n++) {
         e = !1;
         for (var s = 0; s < o.length; s++)
          for (var r = o[s], a = t.hierarchical.distributionOrdering[r], h = 0; h < a.length; h++) u(1e3, a[h]);
         if (!0 !== e) break
        }
     ...
     value: function() {
      var t = this,
       ...
       i = function(i, o, n) {
        var s = t.hierarchical.levels[i.id],
     ...
     value: function() {
      ...
      if (void 0 === i)
       for (var s = 0, r = 0; r < this.body.nodeIndices.length; r++) {
  ...
  Object.defineProperty(e, "__esModule", {
   value: !0
  }), e.VerticalStrategy = e.HorizontalStrategy = void 0;
  var n = i(3),
   s = o(n),
   r = i(4),
   a = o(r),
  ...
  var n = i(30),
   ...
   c = function() {
    ...
    return (0, d.default)(t, [{
     ...
     key: "_getEnergy",
     value: function(t) {
      var e = (0, s.default)(this.E_sums[t], 2),
       i = e[0],
       o = e[1];
     ...
     value: function(t, e, i) {
      ...
      for (var u = e.length, c = 0; c < u; c++)
       for (var p = e[c], f = o[p], m = 0; m < u - 1; m++)
        for (var v = e[m], g = o[v], y = m + 1; y < u; y++) {
         var b = e[y],
          _ = o[b],
