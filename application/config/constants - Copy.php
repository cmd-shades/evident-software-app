...
defined('COMPANY_ADDRESS_SUMMARYLNE')  	OR define('COMPANY_ADDRESS_SUMMARYLNE', 'Evident Software Limited, Unit 1 Mariner Business Center, Kings Way, Croydon CR0 4GB');
