...
$config['tables']['account']        = 'account';
$config['tables']['groups']         = 'user_group_types';
 ...
 */
$config['site_title']                 = "Simply SID";       // Site Title, example.com
$config['admin_email']                = "enockkabungo@simplysid.co.uk"; // Admin Email, admin@example.com
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'email_templates/user/';
#$config['email_templates'] = 'modules/serviceapp/views/email_templates/user/';
