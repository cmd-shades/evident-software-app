...
class Settings extends MX_Controller
{
    ...
    /** Get Table Data **/
    public function get_list_data($module_id = false, $table_name = false, $list_name = false)
    {
    ...
    public function load_table_data_view($module_id = false, $table_name = false, $list_name = false, $order_column = false, $result = false)
    {
    ...
    public function dispatch_add_option_request($module_id = false, $table_name = false, $postdata = false)
    {
        $result = false;
    ...
    public function dispatch_delete_option_request($module_id = false, $table_name = false, $postdata = false)
    {
        $result = false;
        if (!empty($module_id) && !empty($table_name) && !empty($postdata)) {
            $data 			= (object) ['result'=>null, 'message'=>'Something went wrong, please try again!' ];
    ...
    public function dispatch_edit_option_request($module_id = false, $table_name = false, $postdata = false)
    {
        $result = false;
        if (!empty($module_id) && !empty($table_name) && !empty($postdata)) {
            $data 			= (object) ['result'=>null, 'message'=>'Something went wrong, please try again!' ];
    ...
    public function dispatch_get_option_request($module_id = false, $table_name = false, $list_name = false, $order_column = false, $postdata = false)
    {
        $result = false;
        if (!empty($module_id) && !empty($table_name) && !empty($postdata)) {
            $data 			= (object) ['result'=>null, 'message'=>'Something went wrong, please try again!' ];
    ...
    public function load_record_modal($module_id = false, $table_name = false, $list_name = false, $order_column = false, $result = false)
    {
        $return_data = '';
        if (!empty($module_id) && !empty($table_name) && !empty($result)) {
