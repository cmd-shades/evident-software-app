	...
	<div class="x_panel no-border">
		<div class="row">
			<div class="x_content">
				...
				<?php /* ?><div class="hide module-statistics table-responsive alert alert-ssid alert-results" role="alert" style="overflow-y: hidden;" >
                    <legend>Manage Evidoc Names</legend>
                    <div class="hide col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" style="margin:0">
                            <div class="row">
                                <h5 class="text-bold text-center" >Leavers</h5>
                                <h3 class="text-center">0</h3>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12" style="margin:0">
                            <div class="row">
                                <h5 class="text-bold text-center" >Others</h5>
                                <h3 class="text-center">0</h3>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<a href="<?php echo base_url('/webapp/audit/new_type'); ?>" class="btn btn-block btn-success success-shadow" title="Click to add a New EviDoc name"><i class="fas fa-plus-circle" title="" style="font-size: 18px;"></i></a><br/>
							</div>
						</div>
					</div>
