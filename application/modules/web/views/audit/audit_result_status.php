				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<select name="audit_result_status_id" id="audit_result_status_id" class="form-control" required>
							...
							<?php if (!empty($result_statuses)) {
							    foreach ($result_statuses as $result_group) { ?>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="filters">
							<div class="col-md-3 col-sm-3 col-xs-12" style="margin:0">
								<div class="row">
									<h5 class="text-bold text-auto">Audit statuses</h5>
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="row">
									...
									<div class="row">
										...
										<?php if (!empty($audit_types)) {
										    foreach ($audit_types as $k =>$audit_type) { ?>
											<div class="col-md-3 col-sm-6 col-xs-12">
												<span class="checkbox" style="margin:0">
					...
					<table id="datatable" class="table table-responsive" style="margin-bottom:0px;width:100%" >
						<thead>
							<tr>
								...
								<?php /* <th width="15%">Building Name</th>
