<?php if ($module_count > 0) {
    ...
    $inner_columns    = 'col-lg-2 col-md-2 col-sm-4 col-xs-6 col-centered';
    switch ($module_count) {
        case 1:
        case 2:
        case 3:
            ...
            break;
        case 4:
            $container_column = 'col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4';
            $inner_columns    = 'col-lg-6 col-md-6 col-sm-4 col-xs-6';
            break;
        case 5:
        case 6:
        case 9:
            $container_column = 'col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3';
            $inner_columns    = 'col-lg-4 col-md-4 col-centered';
            break;
        case 7:
        case 8:
            #case 10:
        case 11:
        case 12:
            $container_column = 'col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2';
            $inner_columns    = 'col-lg-3 col-md-3 col-centered';
            break;
        case 10:
        case 14:
            #case 11:
            $container_column = 'col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1';
            $inner_columns    = 'col-lg-3 col-md-5th-1 col-centered';
            break;
        default:
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row row-centered">
            <div class="<?php echo $container_column; ?>">
