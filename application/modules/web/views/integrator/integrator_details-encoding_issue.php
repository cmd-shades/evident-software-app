...
$account_id = 1;
$distribution_group_id = 5;



$distro_details = $this->db->select('dg.*, delivery_nodes.setting_value `delivery_node`, delivery_nodes.value_desc `delivery_desc`, ds.server_name, ds.coggins_id `server_coggins_id`', false)
...
debug($distro_details, "print", false);
...
debug($bundle, "print", false);



$string = "Löic & René oße";
// $output = iconv("UTF-8", "Windows-1252//TRANSLIT", $string);
// $output = iconv("UTF-8", 'ASCII//TRANSLIT', utf8_encode( $string ) );
$output = iconv("UTF-8", "Windows-1252", $string);
debug($output, "print", false);


$item = (object)[];
$item->phrase1 = "Böswillige und Aurora werden zu den gegnerischen";
$item->phrase2 = "Seiten eines großen Krieges auseinander gezogen";
$item->phrase3 = "um ihre Loyalität zu testen.";

$st1 = html_entity_decode($item->phrase2);
debug(['$st1'], "print", false);
debug($st1, "print", false);


$st2 = utf8_encode($st1);
debug(['$st2'], "print", false);
debug($st2, "print", false);


$st3a = iconv("UTF-8", "Windows-1252", $st1);
debug(['$st3a'], "print", false);
debug($st3a, "print", false);

$st3c = iconv("UTF-8", "Windows-1252", $item->phrase2);
debug(['$st3c'], "print", false);
debug($st3c, "print", false);

## blad jest tu!!!
$st3b = iconv("UTF-8", "Windows-1252//IGNORE", $st2);
// $st3b = iconv( "UTF-8", "Windows-1252//TRANSLIT", $st2 );
debug(['$st3b'], "print", false);
debug($st3b, "print", false);

// $encoded1    = iconv( "UTF-8", "Windows-1252", utf8_encode( html_entity_decode( $item->phrase1 ) ) );
// $encoded2    = iconv( "UTF-8", "Windows-1252", utf8_encode( html_entity_decode( $item->phrase2 ) ) );
// $encoded3    = iconv( "UTF-8", "Windows-1252", utf8_encode( html_entity_decode( $item->phrase3 ) ) );
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 input-container">
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">                                
                        <?php if (!empty($integrator_documents)) {
                            foreach ($integrator_documents as $file_group => $files) { ?>
