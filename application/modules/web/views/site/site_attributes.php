				...
				<div class="x_panel tile has-shadow">
					...
					<div class="row" style="border: 0px solid blue;display none;">
						<form id="group_<?php echo $group_key; ?>">
							<input type="hidden" name="profile_id" value="<?php echo (!empty($site_details->site_id)) ? ( int ) $site_details->site_id : '' ; ?>" />
						...
						success:function( data ){
							if( data.status == 1 && ( data.status_msg != '' ) ){
								...
								window.setTimeout( function(){
									location.href = "<?php echo base_url('webapp/site/profile/'); ?>" + <?php echo $site_details->site_id; ?> + "/attributes";
								} ,500);
							} else {
								swal({
									type: 'error',
