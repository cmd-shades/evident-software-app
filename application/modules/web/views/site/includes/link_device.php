<?php /*
Criteria for the devices:
 - where( "device.external_reference_id !=", "" );
 - where_in( "device.airtime_status", ["disconnected"] );
 - where( "product.airtime_segment_ref !=", "" );
*/  ?>

<div id="link-device" class="row">
    <div class="x_panel no-border">
        <div class="row top_row">
            <form id="link_devices_form">
                <input type="hidden" name="site_id" value="<?php echo (!empty($site_id)) ? $site_id : null ; ?>" />
                <div class="row top-header">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="reconnect-devices"><span>Reconnect Devices</span></div>
                    </div>
                    ...
                    <table id="datatable" class="table">
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><img class="link_devices_icon" src="<?php echo base_url("assets/images/icons/xs-link-device.png"); ?>" /><input type="checkbox" id="check_all" /></th>
                            </tr>
                        </thead>
                ...
                <div class="action-row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                        <button class="btn btn-sm btn-block submit-btn btn-success" type="submit">Reconnect Selected Rows</button>
                    </div>
                </div>
            </form>
        </div>
...
$( document ).ready( function(){
    ...
    $( "#link_devices_form" ).on( "submit", function( e ){
        e.preventDefault();

        var selected = ( $( "#link_devices_form #table-results input[type='checkbox']:checked" ) );
        ...
        if( parseInt( selected.length ) > 0 ){
            ...
            $.ajax({
                url: "<?php echo base_url('webapp/site/link_devices'); ?>",
                method: "POST",
