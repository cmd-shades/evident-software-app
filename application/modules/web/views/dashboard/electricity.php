...
<script>
   ...
   function deskrecp(daterange) {
		$('#banner').load(rootFolder+'/application/modules/webapp/views/_partials/discipline-header.php?daterange=' + daterange + '&id=<?php echo $disciplineid;?>&name=<?php echo $disciplinename;?>&account_id=<?php echo $accountid;?>');
		$('#outcomes').load(rootFolder+'/application/modules/webapp/views/_partials/discipline-outcomes.php?daterange=' + daterange + '&id=<?php echo $disciplineid;?>&name=<?php echo $disciplinename;?>&account_id=<?php echo $accountid;?>&limit=15&offset=<?php echo $offset;?>');
		$(".calendar").hide();
