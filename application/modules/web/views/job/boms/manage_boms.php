			...
			<div class="x_content">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<a href="<?php echo base_url('/webapp/job/new_bom'); ?>" class="btn btn-block btn-success success-shadow" title="Click to add a new BOM"><i class="fas fa-plus-circle" title="" style="font-size: 18px;"></i></a><br/>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive alert alert-ssid alert-results" role="alert" style="overflow-y: hidden;" >
					<table id="datatable" class="table table-responsive" style="margin-bottom:0px;width:100%" >
						<thead>
							<tr>
								<th width="50%">BOM Name</th>
								<th width="10%">BOM Code</th>
								<th width="10%">Item Category</th>
								<th width="10%" class="text-right">Item Qty</th>
								<th width="10%" class="text-right">Item Revenue</th>
								<th width="10%" class="text-right">Item Cost</th>
							</tr>
						</thead>
...
<script type="text/javascript">
	...
	$( document ).ready(function(){
		...
		function load_data( search_str, where, start_index ){
			$.ajax({
				url:"<?php echo base_url('webapp/job/boms_bank'); ?>",
				method:"POST",
				dataType: "JSON",
