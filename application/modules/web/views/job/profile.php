									...
									<div class="row col-sm-12">
										<div class="right col-xs-12">
											<table style="width:100%;">
												...
												<tr>
													<td width="30%"><i class="hide fa fa-at text-bold"></i> <label>Job Created By</label></td>
													<td width="60%"><?php echo !empty($job_details->created_by_full_name) ? ucwords($job_details->created_by_full_name) : ''; ?> <?php echo (valid_date($job_details->created_on)) ? ' @ '.date('d-m-Y H:i:s', strtotime($job_details->created_on)) : ''; ?></td>
												</tr>
											</table>
										</div>
									</div>
			    ...
			    if (!empty($job_details->customer_details->addresses)) {
			        foreach ($job_details->customer_details->addresses as $address) {
			            if (strtolower($address->address_type_group) == "main") { ?>
											<table class="table-responsive">
												...
												<tr>
													<td width="30%"><i class="hide fa fa-at text-bold"></i> <label>Location Details</label></td>
													<td width="60%"><?php echo (!empty(ucwords($job_details->zone_name))) ? ucwords($job_details->zone_name) : '' ; ?><?php echo (!empty(ucwords($job_details->location_name))) ? ' - '.ucwords($job_details->location_name) : '' ; ?></td>
												</tr>
											</table>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="row">
							...
							} elseif (!empty($job_details->customer_details)) {
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								...
								<table style="width:100%;">
									...
									<?php } elseif (!empty($job_details->customer_details)) { ?>
										<tr>
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<table style="width:100%;">
									<tr>
										<td width="100%" class="center text-center"><?php echo !empty($job_details->account_discipline_name) ? $job_details->account_discipline_name : ''; ?></td>
									</tr>
									<tr>
										<td width="100%" class="center text-center"><img width="60px;" src="<?php echo !empty($job_details->discipline_image_url) ? $job_details->discipline_image_url : ''; ?>" /></td>
									</tr>
								</table>
							</div>
