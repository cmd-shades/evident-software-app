							...
							<div class="x_panel tile has-shadow">
								...
								<div class="accordion" id="accordion-risks" role="tablist" aria-multiselectable="true">
									<?php if (!empty($job_type_details->ra_required)) { ?>
										<div class="row">
											<?php if (!empty($job_type_details->associated_risks)) {
											    foreach ($job_type_details->associated_risks as $risk_details) { ?>	
												<div class="col-md-6 col-sm-6 col-xs-12">
													<ul class="to_do">
														<li>
															<div class="container">
								...
								<div class="x_panel tile has-shadow">
									...
									<div class="accordion" id="accordion-checklists" role="tablist" aria-multiselectable="true">
										<?php if (!empty($job_type_details->required_checklists)) { ?>
											<div class="row">
												<?php if (!empty($job_type_details->required_checklists)) {
												    foreach ($job_type_details->required_checklists as $checklist_details) { ?>	
													<div class="col-md-6 col-sm-6 col-xs-12">
														<ul class="to_do">
															<li>
																<div class="container">
						...
						<div class="col-md-12">
							<div class="x_panel tile has-shadow">
								...
								<div class="accordion" id="accordion-boms" role="tablist" aria-multiselectable="true">
									<div class="row">
										<?php if (!empty($job_type_details->required_boms)) {
										    foreach ($job_type_details->required_boms as $item_details) { ?>	
											<div class="col-md-12 col-sm-12 col-xs-12">
												<ul class="to_do">
													<li>
														<div class="container">
