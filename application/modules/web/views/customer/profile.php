		...
		<div class="x_content">
			...
			<div class="profile-details-container">
				<div class="row alert alert-ssid" role="alert">
					    ...
					    foreach ($customer_details->addresses as $add_row) {
					        if (strtolower($add_row->address_type_group) == "main") { ?>
											...
											<tr>
												...
												<td width="60%"><?php echo((!empty($add_row->address_line1)) ? $add_row->address_line1 : '');
												echo((!empty($add_row->address_line2)) ? ', '.$add_row->address_line2 : '');
												echo((!empty($add_row->address_line3)) ? ', '.$add_row->address_line3 : '');
												echo((!empty($add_row->address_town)) ? ', '.$add_row->address_town : '');
												echo((!empty($add_row->address_postcode)) ? ', '.$add_row->address_postcode : '');  ?></td>
											</tr>
					...
					} elseif (!empty($customer_details->default_address)) { ?>
