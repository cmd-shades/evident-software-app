		...
		<form id="premises-attribute-creation-form" >
						...
						<div class="form-group" >
							<select id="attribute_name" name="attribute_name" class="form-control required" data-label_text="Attribute name" >
								...
								<?php if (!empty($attributes_bucket)) {
									...
									<?php if (!in_array($attribute->attribute_ref, $linked_attributes)) { ?>
			...
			<div class="premises_attribute_creation_panel2" style="display:none" >
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-success btn-next premises-attribute-creation-steps" data-currentpanel="premises_attribute_creation_panel2" type="button" >Next</button>
					</div>
				</div>
			</div>

			<div class="premises_attribute_creation_panel3" style="display:none" >
				<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-back-attribute" data-currentpanel="premises_attribute_creation_panel3" type="button" >Back</button>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-success btn-next premises-attribute-creation-steps" data-currentpanel="premises_attribute_creation_panel3" type="button" >Next</button>
					</div>
				</div>
			</div>

			<div class="premises_attribute_creation_panel4" style="display:none" >
				<div class="form-group">
				...
				<div class="form-group resp-requirement" style="margin:15px 0">
					<div class="row">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<button class="btn btn-block btn-flow btn-back-attribute" data-currentpanel="premises_attribute_creation_panel4" type="button" >Back</button>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-12">
				...
				if ( result.value ) {
					$.ajax({
						...
						success:function( data ){
							if( ( data.status == 1 ) && ( data.premises_type_attribute !== '' ) ){
								...
								if(!restartOnCreate){
									...
									var changefrom = ".premises_attribute_creation_panel4";
									$( changefrom ).hide( "slide", {direction : 'left'}, 500);
									$( changeto ).delay(600).show( "slide", {direction : 'right'},500);
								}
					...
					$( ".premises_attribute_creation_panel4" ).hide( "slide", { direction : 'left' }, 500 );
