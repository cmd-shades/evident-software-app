	...
	<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
		<div class="modal-body">
			<form id="asset-attribute-creation-form" >
				...
				<input type="hidden" name="asset_type_id" value="<?php echo null; ?>" />
		...
		function createAssetAttribute( event, restartOnCreate = false){
			...
			swal({
				...
				if ( result.value ) {
							...
							if( ( data.status == 1 ) && ( data.asset_attribute !== '' ) ){
								...
								if(!restartOnCreate){
									window.setTimeout(function(){
										location.href = "<?php echo base_url('webapp/asset/attributes'); ?>"
									} ,2000);			
								} else {
									...
									var changefrom = ".asset_attribute_creation_panel2";
									$( changefrom ).hide( "slide", {direction : 'left'}, 500);
									$( changeto ).delay(600).show( "slide", {direction : 'right'},500);	
								}	
					...
					$( ".asset_attribute_creation_panel2" ).hide( "slide", { direction : 'left' }, 500 );
