									...
									<div class="row col-sm-12">
										<div class="right col-xs-12">
											<table style="width:100%;">
												<tr>
													<td width="30%"><label><?php echo (!empty($asset_details->primary_attribuite)) ? ucwords($asset_details->primary_attribuite) : false; ?></label></td>
						...
						<div class="row">
							...
							<table style="width:100%;">
								<tr>
									...
									<td width="60%"><?php echo ucwords($asset_details->asset_type); ?></td>
								</tr>
								<tr>
