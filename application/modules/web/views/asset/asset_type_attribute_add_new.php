<div>
	<div class="modal-body">
		<form id="asset-attribute-creation-form" >
			<input type="hidden" name="override_existing" value="" />
			<input type="hidden" name="page" value="details" />
			<input type="hidden" name="asset_type_id" value="<?php echo (!empty($asset_type_details->asset_type_id)) ? $asset_type_details->asset_type_id : '' ; ?>" />
			<div class="asset_attribute_creation_panel1">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h4>Please select attribute name</h4>
						<div class="form-group" >
							<select id="attribute_name" name="attribute_name" class="form-control required" data-label_text="Attribute name" >
								<option value="" >Select type</option>
								<?php if (!empty($attributes_bucket)) {
								    foreach ($attributes_bucket as $k => $attribute) { ?>
									<option value="<?php echo $attribute->attribute_name; ?>" data-ordering="<?php echo $attribute->ordering; ?>" ><?php echo ucwords($attribute->attribute_name); ?></option>
								<?php }
								    } ?>
							</select>
						</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button id="check-exists" class="btn btn-block btn-flow btn-success btn-next asset-attribute-creation-steps" data-currentpanel="asset_attribute_creation_panel1" type="button">Next</button>				
					</div>
				</div>
			</div>
			
			<div class="asset_attribute_creation_panel2" style="display:none" >
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="resp-extra-options" style="display:none; margin:15px 0">
							...
							<div class="form-group resp-requirement" style="margin:15px 0">
								<?php if (!empty($response_types)) {
									...
									<?php } elseif ($resp_type->response_type == 'numbers_only') { ?>
										<div class="resp_<?php echo $resp_type->response_type; ?> resp-type-options" style="display:none; margin:15px 0">
											<div class="hide form-group">
									...
									<?php } elseif ($resp_type->response_type == 'short_text') { ?>
										<div class="resp_<?php echo $resp_type->response_type; ?> resp-type-options" style="display:none; margin:15px 0">
											<div class="hide form-group">
									...
									<?php } elseif ($resp_type->response_type == 'long_text') { ?>
									...
									<?php } elseif (($resp_type->response_type == 'single_choice') || ($resp_type->response_type == 'multiple_choice')) { ?>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-back-attribute" data-currentpanel="asset_attribute_creation_panel2" type="button" >Back</button>					
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-success btn-next asset-attribute-creation-steps" data-currentpanel="asset_attribute_creation_panel2" type="button" >Next</button>					
					</div>
				</div>
			</div>
			
			<div class="asset_attribute_creation_panel3" style="display:none" >
				<div class="form-group">
					<label>Is this a field mandatory?</label>
					<div class="form-group resp-requirement" style="margin:5px 0">
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="radio">
									<label><input type="radio" name="is_mandatory" value="1" style="margin-top:6px;" > Yes</label>
								</div>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="radio">
									<label><input checked type="radio" name="is_mandatory" value="0" style="margin-top:6px;" > No</label>
								</div>
							</div>
						</div>
					</div>
					<label>Is this field Visible on Mobile Devices when completed?</label>
					<div class="form-group resp-requirement" style="margin:5px 0">
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="radio">
									<label><input type="radio" name="is_mobile_visible" value="1" style="margin-top:6px;" checked> Yes</label>
								</div>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="radio">
									<label><input type="radio" name="is_mobile_visible" value="0" style="margin-top:6px;" > No</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div style="display:none" >
					<div class="form-group">
						<label>Does this field require photo to be upload?</label>
						<div class="resp-requirement" style="margin:5px 0">
							<div class="row">
								<div class="col-md-3 col-sm-6 col-xs-12">
									<div class="radio">
										<label><input class="photo_required" type="radio" name="photo_required" value="1" style="margin-top:6px;" > Yes</label>
									</div>
								</div>
								<div class="col-md-3 col-sm-6 col-xs-12">
									<div class="radio">
										<label><input checked class="photo_required" type="radio" name="photo_required" value="0" style="margin-top:6px;" > No</label>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-back-attribute" data-currentpanel="asset_attribute_creation_panel3" type="button" >Back</button>					
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button class="btn btn-block btn-flow btn-success btn-next asset-attribute-creation-steps" data-currentpanel="asset_attribute_creation_panel3" type="button" >Next</button>					
					</div>
				</div>
			</div>

			<div class="asset_attribute_creation_panel4" style="display:none" >
				<div class="form-group">
					<div class="text-center">
						<p>You are about to submit a request to create a new Asset attribute.</p>
				...
				<div class="form-group resp-requirement" style="margin:15px 0">
					<div class="row">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<button class="btn btn-block btn-flow btn-back-attribute" data-currentpanel="asset_attribute_creation_panel4" type="button" >Back</button>					
						</div>
						<div class="col-md-4 col-sm-4 col-xs-12">
							<button id="create-another-asset-attribute" class="btn btn-block btn-flow btn-info" type="button" >Create Another Attribute</button>					
						</div>
						<div class="col-md-4 col-sm-4 col-xs-12">
							<button id="create-asset-attribute-btn" class="btn btn-block btn-flow btn-success btn-next" type="button" >Create and Finish</button>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	$( document ).ready( function(){
		...
		$(".asset-attribute-creation-steps").click(function(){
		...
		function panelchange( changefrom ){
			...
			var changeto = ".asset_attribute_creation_panel"+panelnumber;
		...
		$( '#create-another-asset-attribute' ).click(function( e ){
			createAssetAttribute( e, true )
		});
		...
		*/
		$( '#create-asset-attribute-btn' ).click(function( e ){
			createAssetAttribute( e )
		});
		
		function createAssetAttribute( event, restartOnCreate = false){
			event.preventDefault();
			
			var formData = $('#asset-attribute-creation-form').serialize();
			...
			swal({
				...
				if ( result.value ) {
					$.ajax({
						url:"<?php echo base_url('webapp/asset/add_asset_type_attribute/'); ?>",
						method:'POST',
						data:formData,
						dataType: 'json',
						success:function( data ){
							if( ( data.status == 1 ) && ( data.asset_attribute !== '' ) ){
								...
								if(!restartOnCreate){
									...
									/* reset asset type attribute form */
									$('#attribute_name').val('')
									...
									/* change to first screen of asset attribute creation */
									var changeto = ".asset_attribute_creation_panel1";
									var changefrom = ".asset_attribute_creation_panel4";
									$( changefrom ).hide( "slide", {direction : 'left'}, 500);
									$( changeto ).delay(600).show( "slide", {direction : 'right'},500);	
								}	
					...
					$( ".asset_attribute_creation_panel4" ).hide( "slide", { direction : 'left' }, 500 );
					go_back( ".asset_attribute_creation_panel2" );
					return false;
				}
			}).catch( swal.noop )
		}
