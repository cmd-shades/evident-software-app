<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel tile has-shadow">
			<legend>Asset Cost Tracking <span class="pull-right"><span class="add-cost-item pointer" title="Click to add a new Cost item for this asset"><i class="fas fa-plus-circle text-green"></i></span></legend>
...
<script>
	$(document).ready(function(){
		...
		$( '#add-cost-item-btn' ).click(function(){
			...
			$.ajax({
				url:"<?php echo base_url('webapp/asset/add_cost_item/'); ?>",
				method:"POST",
				data:formData,
				dataType: 'json',
		...
		$( '.delete-cost-item' ).click(function(e){
			...
			swal({
				...
				if ( result.value ) {
					$.ajax({
						url:"<?php echo base_url('webapp/asset/delete_cost_item/'.$asset_details->asset_id); ?>",
						method:"POST",
						data:{page:'details', asset_id:assetID, cost_item_id:itemId},
						dataType: 'json',
						success:function( data ){
							if( data.status == 1 ){
								swal({
