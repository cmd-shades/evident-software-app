...
class AlertHandlerModel extends Model
{
	/**
	 * @var NotificationModel $notification_service
	 */
    ...
    {
        parent::__construct();
        $notification_service = new NotificationModel();
    }
    ...
    */
    ...
    public function get_site_compliance($account_id = false, $site_id = false, $event_tracking_status_id = false)
    {
