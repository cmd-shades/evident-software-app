...
use App\Adapter\Session;

class AccessModel extends Model
{
	/**
	 * @var Modules_model $module_service
	 */
	private $module_service;

	/**
	 * @var Account_model $account_service
	 */
	...
	public function __construct()
	{
		...
		$this->module_service = $this->model('Modules_model', 'module_service');
		$this->account_service = $this->model('Account_model', 'account_service');
	}
