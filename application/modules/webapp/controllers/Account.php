...
class Account extends MX_Controller {
	...
	*/
	...
	function profile( $account_id = false, $page = 'details' ){
		if( !$this->identity() ){
			redirect('webapp/user/login', 'refresh');
		}
...
//						 debug( $API_call, "print", true );
	...
	function discipline_profile( $discipline_id = false, $page = 'details' ){
	...
	function disciplines( $discipline_id = false, $page = 'details' ){
	...
	**/
	...
	function evidoc_templates( $audit_type_id = false, $src_account_id = false, $page = 'details' ){
