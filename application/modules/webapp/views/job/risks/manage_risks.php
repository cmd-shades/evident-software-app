					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<a href="<?php echo base_url('/webapp/job/new_risk_item' ); ?>" class="btn btn-block btn-success success-shadow" title="Click to add a new Risk"><i class="fas fa-plus-circle" title="" style="font-size: 18px;"></i></a><br/>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive alert alert-ssid alert-results" role="alert" style="overflow-y: hidden;" >
					<table id="datatable" class="table table-responsive" style="margin-bottom:0px;width:100%" >
						<thead>
							<tr>
								<th width="40%">Risk</th>
								<th width="30%">Risk Harm</th>
								<th width="10%">Risk Rating</th>
								<th width="10%">Residual Risk</th>
...
<script type="text/javascript">
	...
	$( document ).ready(function(){
		...
		function load_data( search_str, where, start_index ){
			$.ajax({
				url:"<?php echo base_url('webapp/job/risks_bank'); ?>",
				method:"POST",
