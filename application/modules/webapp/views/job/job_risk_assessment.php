						...
						<div class="panel-body">
							<div class="row table-responsive">
								<table class="table" style="font-size:90%; overflow:hidden">
									...
									<tbody>
										<?php if( !empty( $job_details->associate_risks ) ){ foreach( $job_details->associate_risks as $key => $ass_risk ){ ?>
						...
						<div class="panel-body">
							<div class="row table-responsive">
								<table class="table" style="font-size:90%; overflow:hidden">
									...
									<tbody>
										<?php if( !empty( $job_details->dynamic_risks ) ){ foreach( $job_details->dynamic_risks as $k => $dyn_risk ){ ?>
