<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-12 pull-left">
		<legend>Upload Job Upload Records (csv) <span class="pointer">&nbsp;<small><a id="download_template" href="<?php echo base_url( 'assets/public/csv-templates/JobUploadsTemplate_TSG.csv' ); ?>" target="_blank" download="<?php echo base_url( 'assets/public/csv-templates/JobUploadsTemplate_TSG.csv' ); ?>"><i class="fas fa-download" title="Click to Download Job uploads template"></i></a></small></span></legend>
		<form id="docs-upload-form" action="<?php echo base_url( 'webapp/job/submit_upload_jobs_file/'.$this->user->account_id ); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="x_panel tile has-shadow">
				...
				<div class="form-group" >
					<div class="row">
						<div class="col-md-6">
							<button id="doc-upload-btn" class="btn btn-sm btn-block btn-success" type="submit">Upload Jobs</button>
						</div>
					</div>
				</div>
			</div>
...
<script>
	$( document ).ready(function(){
		...
		$(".jobs-creation-steps").click(function(){
			...
			if( $( "#user-lookup-result" ).val() != "" ){
				...
				var jobsal_email = $( "#user-lookup-result" ).find( 'option:selected' ).data( "jobsal_email" );
				$( '*[name="jobsal_email"]' ).val( jobsal_email );		
		...
		function panelchange(changefrom){
			...
			var changeto = ".jobs_creation_panel"+panelnumber;
