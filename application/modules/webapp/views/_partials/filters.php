<?php if( !empty( $module_identier ) ){ ?>
	...
	<?php }else{ ?>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 min_height_70">
				<button class="filters-toggle btn btn-block btn-default <?php echo $module_identier; ?>-bg <?php echo 'shadow-'.$module_identier; ?>" type="button">Filters <i class="fas fa-caret-down"></i></button>
			</div>
		</div>
	<?php } ?>
<?php } ?>