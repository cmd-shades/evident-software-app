            ...
            <div class="chartoverview building">
              ...
              <div class="building-text">
                ...
                <div class="dis-icon">
                  ...
                  <img src="<?php if($discipline == 'specialist equipment'){$discipline = 'specialist';} echo $GLOBALS['base_url'].'/application/modules/webapp/views/dashboard/images/'.$discipline.'.svg'; ?>" />
                </div>
              </div>
            </div>
          </div>
