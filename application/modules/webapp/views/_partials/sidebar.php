<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
	<div class="menu_section">
		<ul class="nav side-menu">
			...
			<li class="<?php echo ( $active_class == 'reports' ) ? 'active' : ''; ?>" ><a disabled href="<?php echo base_url('/webapp/report/reports'); ?>"><i class="fas fa-chart-bar"></i> <span class="hidden-sm hidden-xs">Reports</span></a></li> 
		</ul>
	</div>
</div>
