							...
							<li class="over">
								...
								<div class="totals overdue <?php echo $discipline;?>">
									<div class="total-icon">
										<img src="<?php if( $discipline == 'specialist equipment' ){$discipline = 'specialist';} echo $base_url.'application/modules/webapp/views/dashboard/images/'.$discipline.'.svg'; ?>" />
										...
										<a href="<?php echo $base_url.'webapp/job/overview?discipline_id='.$disciplines->discipline_id.'&overdue_jobs=1&date_range='.$_COOKIE['daterange'];?>">
											<div class="circle <?php if($disciplines->jobs_total > 0){echo'failed';}else{echo'pass';};?>">
