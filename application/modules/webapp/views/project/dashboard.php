		...
		<div class="x_content">
			<div class="profile-details-container">
				<div class="row alert alert-ssid" role="alert">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="row">
							<div class="rows">
								<legend>Contract Manager</legend>
							</div>
							<div class="rows">
								<?php
								foreach( $stats_to_dashboard as $stats_key ){ ?>
				...
				<div class="row contract_search_bar_row" role="alert">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="row">
			...
			<div class="row">
				<div class="col-md-2 col-sm-3 col-xs-4" style="padding-left:0;">
					<a class="btn btn-block btn-success" href="<?php echo base_url( "/webapp/contract/add_contract" ); ?>">Create new</a>
				</div>
			</div>
		</div>
	</div>
...
<script>
	$( document ).ready( function(){
		...
		load_data( search_str, contract_statuses_arr, contract_types_arr );
		...
		$( "#table-results" ).on( "click", "li.page", function( event ){
			...
			load_data( search_str, contract_statuses_arr, start_index );
		});
