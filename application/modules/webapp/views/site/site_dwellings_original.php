	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<form id="add-dwellings-form" class="form-horizontal">
			...
			<div class="x_panel tile has-shadow">
				<legend>Add Dwellings <em style="font-size:70%;display:block"><small>Click on the Building Postcode to add or remove dwellings</small></em></legend>
				
				<div class="input-group form-group">
					<label class="input-group-addon" >Building Postcode</label>
					<input value="<?php echo !empty( $site_details->site_postcodes ) ? $site_details->site_postcodes : ''; ?>" title="This will show all dwelings listed on <?php echo !empty( $site_details->site_postcodes ) ? $site_details->site_postcodes : ' this building\'s postcode'; ?>" readonly class="form-control site-postcodes" type="text" placeholder="Comma separated e.g. CR0 4GE, CR0 9XP"  />
				</div>				
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<!-- <td class="pull-right"><span class="hide"><span class="edit-modal"><i class="far fa-edit text-blue pointer" disabled></i></span> &nbsp;|&nbsp; <a class="disabled drop-dwelling" href="<?php echo base_url( '/site/delete_dwelling/'.$site_details->site_id.'/'.$dwelling->dwelling_id ); ?>"><i class="fas fa-trash-alt text-red pointer" disabled></i></a></span></td> -->
								</tr>
								<?php } ?>
							</tbody>
						</table>
