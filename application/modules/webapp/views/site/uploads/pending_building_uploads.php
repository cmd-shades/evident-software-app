...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel tile has-shadow">
			<legend>Review Pending Building Uploads</legend>
			<?php if( !empty( $pending_buildings ) ) { ?>
				<div class="row">
					<div class="col-md-12">
						<div style="overflow-y: hidden;" >
							<?php foreach( $pending_buildings as $group => $records ){ ?>
									...
									<table width="100%" >								
										...
										<tr class="grp_<?php echo $group;?>" style="display:none">
											<td colspan="2" width="100%" >
												<table class="table table-responsive" style="width:100%; font-size:86%" >
													<tr>
			...
			<?php } else { ?>
				<div class="row">
					...
					<div class="col-md-3">
						<a href="<?php echo base_url( 'webapp/site/upload_buildings'); ?>" class="btn btn-sm btn-block btn-info" type="submit" >Start Building Upload</a>					
					</div>
				</div>
			<?php } ?>
		</div>
...
<script>
	$(document).ready(function(){
		...
		$( 'select[class="changeable-field"], .changeable-field' ).change( function(){
			var tempUserId 	= $( this ).closest('tr').data( 'temp_site_id' );
		...
		$( '.submit-records' ).click( function( e ){
			...
			if( actionType == 'add' ){
				var postUrl = "<?php echo base_url('webapp/site/process_building_uploads/' ); ?>";
			} else if ( actionType == 'remove' ){
				var postUrl = "<?php echo base_url('webapp/site/drop_temp_building_records/' ); ?>";
			}
			...
			swal({
				title: 'Confirm '+actionType+' upload Building records?',
