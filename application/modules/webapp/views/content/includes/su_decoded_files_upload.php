...
<div class="col-md-6 col-sm-6 col-xs-12 pull-left">
    ...
    <form id="docs-upload-form" action="<?php echo base_url('webapp/content/su_decoded_files_upload/'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
