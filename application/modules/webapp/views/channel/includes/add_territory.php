<div class="modal-body">
	<form id="adding-territory-to-channel-form" >
		<input type="hidden" name="channel_id" value="<?php echo ( !empty( $channel_details->channel_id ) ) ? ( $channel_details->channel_id ) : '' ; ?>" />
		<div class="row">
			<div class="adding-territory-to-channel1 col-md-12 col-sm-12 col-xs-12">
				<div class="slide-group">
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<h6 class="error_message pull-right" id="adding-territory-to-channel1-errors"></h6>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12 pull-right">
							<button class="btn-block btn-next" data-currentpanel="adding-territory-to-channel3" type="submit">Add Territory</button>
						</div>
					</div>
				</div>
			</div>
