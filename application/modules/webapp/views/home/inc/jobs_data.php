				...
				<div class="evi_content">
					<table class="table table-responsive no-top-border" >
						...
						<tbody id="monthly_jobs_data" >
							<?php if( !empty( $monthly_jobs_data ) ){ foreach( $monthly_jobs_data as $category => $monthly_category_data ){ ?>
								<tr>
				...
				<div class="evi_content">
					<table class="table table-responsive no-top-border" >
						...
						<tbody id="annual_jobs_data" >
							<?php if( !empty( $annual_jobs_data ) ){ foreach( $annual_jobs_data as $category => $annual_category_data ){ ?>
								<tr>
