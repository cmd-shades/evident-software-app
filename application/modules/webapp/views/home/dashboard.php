...
<div class="row" style="">
	<div class="x_content">
		<div class="col-md-12 col-sm-12 col-xs-12 module-header">
			<h3><strong>Home</strong><span style="font-size: 12px;display: inline; float: right;color: black;"><a href="<?php echo base_url( "webapp/home/index?dashboard2=1" ); ?>">Dashboard 2</a></span></h3>
		</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_title no-border text-center" >
				<h2 id="siteComplianceLabel"><small>Building Safety Asset Performance</small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container">
				<div class="x_content">
        ...
        <?php /*
        <!-- Assets by Evidoc Categories -->
        <div class="col-md-6 col-sm-6 col-xs-12">
			<div class="x_title no-border text-center">
				<h2 id="assetsByCategoryLabel"><small>Assets by EviDoc Categories</small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container">
				<div class="x_content">
					<canvas id="barchart-9"></canvas>
                    <br/>
                    <div class="stat-error"></div>
				</div>
			</div>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
			<div class="x_title no-border text-center">
				<h2 id="exceptionStatusesLabel"><small>Assets by Asset Types</small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container" >
				<div class="x_content">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="x_title no-border text-center">
				<h2 id="atitle2021"><small>Schedules <?php echo date( 'Y' ); ?></small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<div class="x_title no-border text-center">
				<h2 id="atitle"><small>Inspection Status</small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container">
				<div class="x_content">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<div class="x_title no-border text-center">
				<h2 id="atitle"><small>Inspection Completion Rates</small></h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_panel border-radius-10 has-shadow stats-container">
				<div class="x_content">
			...
			switch( chartType.toLowerCase() ){
                ...
                case 'assetcompliance':
                    ...
                    var dataAvailable = false;
                        ...
                        compliance_text = ( total > 0 ) ? parseFloat( ( compliant / total ) * 100 ).toFixed( 0 ) + '%' : "0%"
