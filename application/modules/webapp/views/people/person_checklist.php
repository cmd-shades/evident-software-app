...
<div class="row checklist">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <?php
        if (!empty($checklist_questions->procedures)) {
            foreach ($checklist_questions->procedures as $type_key => $item_type) {
                if (!empty($checklist_answers->{ 'procedures' }->$type_key)) {
                    $answers = json_decode($checklist_answers->{ 'procedures' }->$type_key[0]->{ 'answers' });
                } ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="x_panel tile has-shadow">
                        <form class="form-horizontal">
                            ...
                            <input type="hidden" name="category" value="procedures" />
