      ...
      <div class="container nopad-xs">
        <div class="row summary-headings hidden-sm">
          ...
          <div class="col-xs-12 col-md-7 fright-filter hidden-xs">
            ...
            <div class="filter">
               <!-- 7 day filter START -->
               <a id="7" href="#" class="btn <?php if($_COOKIE['daterange'] === '7'){ echo 'active' ;}?>  datefilter" >7 days</a>
               <!-- 7 day filter END -->
               <!-- 30 day filter START -->
               <a id="30" href="#" class="btn <?php if($_COOKIE['daterange'] === '30'){ echo 'active' ;}?> datefilter" >30 days</a>
               <!-- 30 day filter END -->
               <!-- 90 day filter START -->
               <a id="90" href="#" class="btn <?php if($_COOKIE['daterange'] === '90'){ echo 'active' ;}?> datefilter" >90 days</a>
               <!-- 90 day filter END -->
               <!-- 180 day filter START -->
               <a id="180" href="#" class="btn <?php if($_COOKIE['daterange'] === '180'){ echo 'active' ;}?> datefilter" >180 days</a>
               <!-- 180 day filter END -->
               <!-- 365 day filter START -->
               <a id="365" href="#" class="btn <?php if($_COOKIE['daterange'] === '365'){ echo 'active' ;}?> datefilter" >Year</a>
               <!-- 365 day filter END -->
               <!-- Custom date filter -->
