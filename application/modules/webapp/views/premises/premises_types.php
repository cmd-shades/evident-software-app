					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<a href="<?php echo base_url( '/webapp/premises/create_premises_type' ); ?>" class="btn btn-block btn-success success-shadow" title="Click to add a New asset name"><i class="fas fa-plus-circle" title="" style="font-size: 18px;"></i></a><br />
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	$( document ).ready(function(){
		...
		function load_data( search_str, where, start_index ){
			$.ajax({
				url:"<?php echo base_url('webapp/premises/premises_types_list'); ?>",
				method:"POST",
