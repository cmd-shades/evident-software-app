			...
			<div class="profile-details-container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h2 class="profile-header">Provider Profile <?php echo ( !empty( $provider_details->provider_id ) ) ? " (ID: ".$provider_details->provider_id.")" : '' ; ?></h2><?php if( !empty( $provider_details ) ){ ?><div class="delete_container"><a href="#"><i class="fas fa-trash-alt"></i></a></div><?php } ?>
					</div>
				</div>
				<?php
