		...
		<div class="col-md-12 col-sm-12 col-xs-12" style="border: 0px solid red;">
			...
			<?php foreach( $section as $group_key => $group ){ ?>  <!-- group -->
				<div class="x_panel tile has-shadow">
					<legend class="legend">Black with orange triangle - Group Key: ( <?php echo $group_key; ?> )</legend>
					<div class="row" style="border: 0px solid blue;display none;">
						<form id="group_<?php echo $group_key; ?>">
							<input type="hidden" name="profile_id" value="<?php echo ( !empty( $vehicle_details->vehicle_id ) ) ? ( int ) $vehicle_details->vehicle_id : '' ; ?>" />
						...
						success:function( data ){
							if( data.status == 1 && ( data.status_msg != '' ) ){
								...
								window.setTimeout( function(){
									location.href = "<?php echo base_url( 'webapp/fleet/profile/' ); ?>" + <?php echo $vehicle_details->vehicle_id; ?> + "/attributes";
								} ,500);
							} else {
								swal({
									type: 'error',
