<div class="row">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<form id="upload-docs-form" action="<?php echo base_url( "webapp/fleet/upload_docs/".$vehicle_details->vehicle_id ) ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
			<input type="hidden" name="vehicle_id" value="<?php echo $vehicle_details->vehicle_id; ?>" type="text" readonly />
			<input type="hidden" name="vehicle_reg" value="<?php echo $vehicle_details->vehicle_reg; ?>" type="text" readonly />
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<div class="x_panel tile has-shadow">
			<legend>Fleet Audit Documents</legend>
			<div class="row">
