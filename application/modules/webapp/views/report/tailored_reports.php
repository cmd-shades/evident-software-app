							...
							<form id="fetch-report-form" class="form-horizontal" action="<?php echo base_url('/webapp/report/reports/' ); ?>" method="post" >
								...
								<div class="row">
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select id="tailored_contract_id" name="contract_id" class="form-control" style="width:100%; display:none; margin-bottom:10px;" >
											<option value="">All (no filter)</option>
											<?php if( !empty( $tailored_contracts ) ){ foreach( $tailored_contracts as $key => $contract ) { ?>
								...
								<?php if( !empty( $tailored_reports ) ) { ?>
									<h5 class="text-bold">Please select the report type you require</h5>
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<?php foreach( $tailored_reports as $report_type=>$report_setup ){ ?>
