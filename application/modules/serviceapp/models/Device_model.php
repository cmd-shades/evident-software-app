...
class Device_model extends CI_Model {
	...
	*/
	function _prepare_data_for_segment_update( $easel_segment_id = false, $easel_source_segment_data = false, $device_easel_id = false, $action = "add" ){
		$result = false;
		if( !empty( $easel_segment_id ) && !empty( $easel_source_segment_data ) && !empty( $device_easel_id ) ){
			...
			} else if( mb_strtolower( $action, 'UTF-8' ) == "remove" ){
