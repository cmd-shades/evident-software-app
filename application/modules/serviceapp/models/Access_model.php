...
class Access_model extends CI_Model
{
    ...
    * Check user access to a module item
    */
    public function get_module_items($account_id = false, $module_id = false, $detailed = false)
    {
        $result = false;
        if (!empty($account_id) && !empty($module_id)) {
            $module_items = $this->account_service->get_account_modules_items($module_id, $detailed);
