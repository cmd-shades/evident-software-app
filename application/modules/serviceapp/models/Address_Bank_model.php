...
class Address_Bank_model extends CI_Model
{
    ...
    function get_addresses($search_term, $limit = false)
    {
        $result = false;
    ...
    function local_postcode_lookup($search_term = false, $addresseslist = false, $where = false, $limit = false)
    {
        $result = false;
    ...
    function api_postcode_lookup($search_term)
    {
