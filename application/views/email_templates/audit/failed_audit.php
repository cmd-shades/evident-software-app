...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin: 0; padding: 0; font-family: 'Droid Sans', Arial;">
		<table align="center" border="0" cellpadding="4" cellspacing="0" width="70%">
			...
			<tr>
				<td colspan="4">An Audit was completed an marked as <strong style="color:<?php echo ( !empty( $content['result_status_colour'] ) ) ? $content['result_status_colour'] : ''; ?>">Failed</strong>. Details are shown below</td>
			</tr>
			<tr>
				<td colspan="4" >
					<table align="center" border="0" cellpadding="4" cellspacing="0" width="100%">
						...
						<tr>
							<td width="100%" colspan="2"><strong>FAILURE REASON / DETAILS</strong></td>
						</tr>
						<tr>
							<td width="100%" colspan="2"><em><?php echo ( !empty( $content['failure_reasons'] ) ) ? $content['failure_reasons'] : 'No data submitted...'; ?></em></td>
						</tr>
					</table>
				</td>
			</tr>
