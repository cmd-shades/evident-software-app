...
class KoolPasswordValidator extends _KoolValidator
{
	function _GetClass()
	{
		return "KoolPasswordValidator";
	}	
}
...
class KoolForm
{
    ...
    $_tpl_main = "{trademark}{content}";
		$_main = _replace("{trademark}", $_trademark, $_tpl_main);
		if(true)
		{
