...
.PHONY: enable-xdebug-php-app
enable-xdebug-php-app: ## Enable XDebug for PHP app
	make enable-xdebug DOCKER_SERVICE_NAME=application

.PHONY: enable-xdebug-php-fpm
enable-xdebug-php-fpm: ## Enable XDebug for PHP fpm
	make enable-xdebug DOCKER_SERVICE_NAME=php-fpm

.PHONY: enable-xdebug-php-worker
enable-xdebug-php-worker: ## Enable XDebug for PHP worker
