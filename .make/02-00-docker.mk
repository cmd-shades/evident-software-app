...
# e.g.               docker.io/envx/nginx-local
...
DOCKER_COMPOSE_PROJECT_NAME:=appenvx_$(ENV)
...
.PHONY: validate-docker-variables # docker vaalidate
...
docker-build-no-cache: @$(DOCKER_COMPOSE) build --no-cache
...
#.PHONY: docker-up
#docker-up: validate-docker-variables ## Create and start all docker containers. To create/start only a specific container, use DOCKER_SERVICE_NAME=<service>
#	@$(DOCKER_COMPOSE) up --build --force-recreate --remove-orphans -d $(DOCKER_SERVICE_NAME)
...
docker-refresh: validate-docker-variables docker-down docker-build-php  ## Docker refresh
