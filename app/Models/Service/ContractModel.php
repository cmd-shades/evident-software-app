...
class ContractModel extends Model
{
    ...
    *	Update Contract
    */
    public function updateContract($account_id = false, $contract_id = false, $contract_data = false)
    {
        $result = false;
        if (!empty($account_id) && !empty($contract_id) && !empty($contract_data)) {
            ...
            $this->session->setFlashdata('message', 'No Account ID, no Contract Id or no new data supplied.');
        }
        return $result;
    }
