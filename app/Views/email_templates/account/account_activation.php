              ...
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                    <tr>
                      <td style="width:130px;background:#5cb85c;">
                        <div>
                          <!--[if mso]>
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo base_url('webapp/account/activate/'.$account_data->activation_code); ?>" style="height:33px;v-text-anchor:middle;width:130px;" stroke="f" fillcolor="#5cb85c">
                            <w:anchorlock/>
                            <center>
                          <![endif]-->
                ...
                <td class="mobile-hide" style="padding-top:20px;padding-bottom:0;vertical-align:bottom">
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <img  style="display:block" src="<?php echo base_url('assets/images/email-assets/mob-hand.png'); ?>"  width="174" height="294" alt="iphone"/>
                      </td>
                    </tr>
                  </table>
                </td>
