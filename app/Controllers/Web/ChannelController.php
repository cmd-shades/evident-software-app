...
use App\Models\Service\ChannelModel;

class ChannelController extends MX_Controller
{
	/**
	 * @var \App\Models\Service\ChannelModel $channel_service
	 */
    ...
    **/
    ...
    public function profile($channel_id = false, $page = 'details')
    {
