...
class AssetController extends MX_Controller
{
	/**
    ...
    public function profile($asset_id = false, $page = 'details')
    {
    ...
    */
    ...
    //Manage Asset types
    public function asset_types($asset_type_id = false, $page = 'details')
    {
    ...
    **/
    ...
    public function attributes($attribute_id = false, $page = 'details')
    {
        $toggled	= (!empty($this->input->get('toggled')) ? $this->input->get('toggled') : false);
        $section 	= (!empty($page)) ? $page : (!empty($this->input->get('page')) ? $this->input->get('page') : 'details');
