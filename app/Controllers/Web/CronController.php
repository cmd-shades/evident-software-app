...
use App\Models\Service\InternalCommonModel;

class CronController extends MX_Controller
{
    /**
     * @var \App\Models\Service\InternalCommonModel
     */
    ...
    {
        parent::__construct();
        $this->common_service = new InternalCommonModel();
    }
